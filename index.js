...
Есть ли футбольный стадион: ${stadium}
`)
...
const res = (speedOfFirst + speedOfSecond) * time
console.log(`Расстоянии находятся города друг от друга: ${res}`)
/* 
    Задание 4:
...
if(randomNumber<20){
    ...
    console.log("andomNumber больше 50")
} else{
...
*/
const randomNumberWithSwitch = Math.floor(Math.random() * 100);
switch (randomNumberWithSwitch) {
    case randomNumberWithSwitch < 20:
        console.log("randomNumber меньше 20")
        break;
    case randomNumberWithSwitch > 50:
        console.log("andomNumber больше 50")
        break;
    default:
        console.log("randomNumber больше 20, и меньше 50")
